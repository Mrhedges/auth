...
/**
 * as of 1.0.0.RC2  default factory does not properly instantiate due to dependency issues.  Internal copy should be discarded when release works<BR><BR><BR><BR> 
...
{
    /** A logger */
    private static final Logger LOG = Logger.getLogger( StandaloneLdapApiService.class.getName() );
    ...
    private static List<String> getControlsFromSystemProperties() throws Exception
    {
        ...
        else
        {
            ...
            if ( !isEmpty( oldDefaultControlsString ) )
            {
    ...
    private static List<String> getExtendedOperationsFromSystemProperties() throws Exception
    {
        ...
        if ( !isEmpty( defaultExtendedOperationsList ) )
        {
    ...
    private void loadControl( String controlFQCN ) throws Exception
    {
        ...
        {
            LOG.fine( "Factory for control {} was already loaded" + controlFQCN );
            return;
        }
    ...
    private void loadExtendedOperation( String extendedOperationFQCN ) throws Exception
    {
        ...
        {
            LOG.fine( "Factory for extended operation {} was already loaded" +  extendedOperationFQCN );
            return;
        }
