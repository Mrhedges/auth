...
public interface TokenService<PayloadType>
{
    ...
    * @param expiresIn The amount of time to add to "right now" to set as the token's expiration.
    * @param expiresInUnit The units for 'expiresIn'
    ...
    * instance using {@link #createTokenData(Object, long, TimeUnit)}.
    * <p>
