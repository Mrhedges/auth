...
public class DatabaseAccountStore implements AccountStore
{
   ...
   private final class CreateAccountTask implements SqlExecutor.ExecutorTask<DatabaseAccount>
   {
      private final AtomicReference<DatabaseAccount> ref;

      private CreateAccountTask(AtomicReference<DatabaseAccount> ref)
      {
         this.ref = ref;
      }
   ...
   private final class AccountLookupTask implements SqlExecutor.ExecutorTask<DatabaseAccount>
   {
      private final String pid;
      private final String puid;

      private AccountLookupTask(String pid, String puid)
      {
         this.pid = pid;
         this.puid = puid;
      }
   ...
   @Override
   public DatabaseAccount lookup(LoginData loginData) throws AccountException
   {
      ...
      SqlExecutor.ExecutorTask<DatabaseAccount> task = new AccountLookupTask(pid, puid);
   ...
   public Account createAccount(String title) throws AccountException
   {
      ...
      SqlExecutor.ExecutorTask<DatabaseAccount> task = new CreateAccountTask(ref);
